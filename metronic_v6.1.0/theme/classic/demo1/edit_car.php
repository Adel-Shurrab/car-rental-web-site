...
session_start();
if (isset($_SESSION['email']) && isset($_SESSION['password']) && isset($_SESSION['type']) && $_SESSION['type'] == 1) {
    ...
    do {
        ...
        if (isset($_POST['edit']) && isset($_GET["id"])) {
            ...
            $price2 = $_POST['price'];
            $availability2 = $_POST['availability'];

            if (empty($quantity2)) {
                $errors['quantity'] = "Enter the Quantity, please";
            } else if (!is_numeric($quantity2)) {
                $errors['quantity'] = "Please enter a numeric value for Quantity";
                break;
            }
            ...
            if (empty($price2)) {
                ...
                $errors['price'] = "Please enter a numeric value for Price per hour";
            } else if ($price2 >= 100) {
            ...
            if ($availability2 == '') {
                $errors['availability'] = "Enter your option";
                break;
            }

            $quantity3;

            if (empty($errors['quantity']) && empty($errors['price']) && empty($errors['availability'])) {
                if ($availability2 == 'Available') {
                    $quantity3 = $quantity + $quantity2;
                } else if ($availability2 == 'Non-available') {
                    if ($quantity2 >= $quantity) {
                        $errors['quantity'] = "Quantity cannot be greater than or equal to the original quantity";
                        break;
                    } else {
                        $quantity3 = $quantity - $quantity2;
                    }
                ...
                // Check if new image is provided and different from existing image before updating
                if (!empty($filename1) && $filename1 !== $img1) {
                    $sql = "UPDATE `cars` SET `img1`='$filename1' WHERE car_id = $id";
                    $result = $connection->query($sql);
                    if ($result) {
                        move_uploaded_file($filetmp1, "./uploads/" . $filename1);
                    }
                }

                if (!empty($filename2) && $filename2 !== $img2) {
                    $sql = "UPDATE `cars` SET `img2`='$filename2' WHERE car_id = $id";
                    $result = $connection->query($sql);
                    if ($result) {
                        move_uploaded_file($filetmp2, "./uploads/" . $filename2);
                    }
                }

                if (!empty($filename3) && $filename3 !== $img3) {
                    $sql = "UPDATE `cars` SET `img3`='$filename3' WHERE car_id = $id";
                    $result = $connection->query($sql);
                    if ($result) {
                        move_uploaded_file($filetmp3, "./uploads/" . $filename3);
                    }
                }

                if (!empty($filename4) && $filename4 !== $img4) {
                    $sql = "UPDATE `cars` SET `img4`='$filename4' WHERE car_id = $id";
                    $result = $connection->query($sql);
                    if ($result) {
                        move_uploaded_file($filetmp4, "./uploads/" . $filename4);
                    }
                }

                $sql = "UPDATE `cars` SET `quantity`='$quantity3', `price_per_hour`='$price2', `availability`='Available' WHERE car_id = $id";
                $result = $connection->query($sql);
...
-->
                            ...
                            <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_tools_1">
                                ...
                                <div class="kt-portlet__body">
                                    <div class="kt-portlet__content">
                                        <form method="post" class="addcour-form" enctype="multipart/form-data">
                                            <div class="row">
                                                <!-- start col -->
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="text" name="quantity" value="<?php echo $quantity; ?>" placeholder="quantity" class="form-control">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="text" name="price" value="<?php echo $price; ?>" placeholder="price ber hour" class="form-control">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <select class="form-control kt-select2" class="kt_select2_1" name="availability">
                                                            <option value="" disabled selected>select availability</option>
                                                            <option value="Available">Available</option>
                                                            <option value="Non-available">Non-available</option>
                                                        </select>
                                                        <p class="text-danger"><?php echo $errors['availability']; ?></p>
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="input-group" style="margin-bottom: 15px;">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" name="img1" value="<?php echo $img1; ?>" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept=".jpg, .jpeg, .png">
                                                    ...
                                                    <div class="input-group" style="margin-bottom: 15px;">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" name="img2" value="<?php echo $img2; ?>" class="custom-file-input" id="inputGroupFile02" aria-describedby="inputGroupFileAddon02" accept=".jpg, .jpeg, .png">
                                                    ...
                                                    <div class="input-group" style="margin-bottom: 15px;">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" name="img3" value="<?php echo $img3; ?>" class="custom-file-input" id="inputGroupFile03" aria-describedby="inputGroupFileAddon03" accept=".jpg, .jpeg, .png">
                                                    ...
                                                    <div class="input-group" style="margin-bottom: 15px;">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" name="img4" value="<?php echo $img4; ?>" class="custom-file-input" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" accept=".jpg, .jpeg, .png">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input type="submit" name="edit" value="Edit car" class="btn btn-info add-btn">
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                            </div>
        ...
        <!--begin::Modal 3-->
        <div class="modal fade" id="kt_modal_4_2" id="" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="addcour-form m3" method="post" id="imgform" target="votar" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="d1">
                                    <div class="c1">
                                        ...
                                        <label for="file">upload main image</label>
                                    </div>
                                </div>
